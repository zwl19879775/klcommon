...
namespace Private
{
	...
	{
		static const Number &ValidVal()
		{
			static Number valid = -99999999;
			return valid;
		}
	};
	...
	{
		static const tString &ValidVal()
		{
			static tString valid( "" );
			return valid;
		}
	};
	...
	{
		static const CGUID &ValidVal()
		{
			static CGUID valid = NULL_GUID;
			return valid;
		}
	};
